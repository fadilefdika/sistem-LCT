                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('manajemen-pic')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('manajemen-pic')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.manajemen-pic') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-xs font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('manajemen-pic')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">Master Data</span>
                            </div>
                        </a>
                    </li>
                    @endrole
