            ...
            <div>
                ...
                <ul class="mt-3 flex flex-col gap-2">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('dashboard')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('dashboard')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.dashboard') }}">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('dashboard')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">Dashboard</span>
                                </div>
                        </a>
                    </li>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('laporan-lct') || Request::is('laporan-lct/*')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('laporan-lct') || Request::is('laporan-lct/*')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.laporan-lct') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('laporan-lct') || Request::is('laporan-lct/*')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">LCT Reports</span>
                            </div>
                        </a>
                    </li>
                    @endrole
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('manajemen-lct') || Request::is('manajemen-lct/*')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('manajemen-lct') || Request::is('manajemen-lct/*')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.manajemen-lct') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('manajemen-lct') || Request::is('manajemen-lct/*')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">LCT Management</span>
                            </div>
                        </a>
                    </li>
                    @endrole
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('budget-approval') || Request::is('budget-approval/*')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('budget-approval') || Request::is('budget-approval/*')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.budget-approval') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('budget-approval') || Request::is('budget-approval/*')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">Activity Approval</span>
                            </div>
                        </a>
                    </li>
                    @endrole
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('budget-approval-history') || Request::is('budget-approval-history/*')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('budget-approval-history') || Request::is('budget-approval-history/*')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.budget-approval-history') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('budget-approval-history') || Request::is('budget-approval-history/*')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">Activity Approval History</span>
                            </div>
                        </a>
                    </li>
                    @endrole
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('progress-perbaikan') || Request::is('progress-perbaikan/*')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('progress-perbaikan') || Request::is('progress-perbaikan/*')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.progress-perbaikan') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('progress-perbaikan')|| Request::is('progress-perbaikan/*')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">Activity Progress</span>
                            </div>
                        </a>
                    </li>
                    @endrole
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(Request::is('riwayat-lct') || Request::is('riwayat-lct/*')){{ 'from-[#048cfb]/[0.12] to-[#048cfb]/[0.04]' }}@endif">
                        <a class="block text-gray-700 dark:text-gray-100 truncate transition @if(!Request::is('riwayat-lct') || Request::is('riwayat-lct/*')){{ 'hover:text-gray-900 ' }}@endif" href="{{ route('admin.riwayat-lct') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-light ml-4 lg:opacity-100 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if(Request::is('riwayat-lct') || Request::is('riwayat-lct/*')){{ 'text-gray-900' }}@else{{ 'text-gray-400 dark:text-gray-900' }}@endif">LCT History</span>
                            </div>
                        </a>
                    </li>
                    @endhasanyrole
