<x-app-layout>
    ...
    <div x-data="{ activeTab: '{{ in_array($laporan->status_lct, ['approved_temporary','waiting_approval_taskbudget', 'taskbudget_revision','approved_taskbudget', 'work_permanent','waiting_approval_permanent','permanent_revision', 'approved_permanent']) ? 'task-and-timeline' : 'laporan'}}' }"
        ...
        <div class="flex space-x-4 border-b">
            ...
            @if(in_array($laporan->tingkat_bahaya, ['Medium', 'High']) && in_array($laporan->status_lct, ['waiting_approval_temporary','approved_temporary','waiting_approval_taskbudget', 'taskbudget_revision','approved_taskbudget', 'work_permanent','waiting_approval_permanent','permanent_revision', 'approved_permanent']))
