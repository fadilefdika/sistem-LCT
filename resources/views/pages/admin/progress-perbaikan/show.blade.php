    ...
    <div x-data="{ 
     ...
     class="px-0 md:px-5 pt-2">
        ...
        <div class="flex space-x-4 border-b">
            ...
            @if(in_array($laporan->tingkat_bahaya, ['Medium', 'High']) && in_array($laporan->status_lct, ['approved_temporary','approved_taskbudget','taskbudget_revision','waiting_approval_taskbudget','waiting_approval_permanent','approved_permanent','closed']))
