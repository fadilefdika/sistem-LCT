                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Tanggal Temuan</th>
                                <th scope="col" class="px-4 py-3">Area</th>
                                <th scope="col" class="px-4 py-3">Foto Temuan</th>
                                <th scope="col" class="px-4 py-3">Kategori Temuan</th>
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">Aziz</td>
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">Kerusakan Tempat Sampah</th>
                                <td class="px-4 py-3">20-12-2024</td>
                                <td class="px-4 py-3">Gudang A</td>
                                <td class="px-4 py-3">
