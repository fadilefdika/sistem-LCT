...
class ManajemenLCTTable extends Component
{
    ...
    public function render()
    {
        ...
        $laporans = LaporanLct::whereIn('status_lct', ['in_progress', 'progress_work', 'waiting_approval', 'rejected', 'approved','waiting_approval_temporary','waiting_approval_taskbudget', 'approved_temporary', 'temporary_revision', 'work_permanent', 'waiting_approval_permanent', 'approved_permanent', 'permanent_revision']) // Hanya yang dikirim EHS
